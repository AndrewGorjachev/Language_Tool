...
class CommonToolView:
    ...
    def set_right_answers(self, right_answers):
        ...
        if self.total_answers > 0:
            answ_percent = (right_answers / self.total_answers * 100)
    ...
    def set_wrong_answers(self, wrong_answers: int):
        ...
        answ_percent=0
        if self.total_answers > 0:
            answ_percent=(wrong_answers/self.total_answers * 100)
    ...
    def show_warning(self, warning_message):
        OpenSplashView("Warnung", warning_message)

    def show_mistake(self, right_answer):
        OpenSplashView("Fehler", right_answer)
    ...
    def on_show_translation(self):
        ...
        if translation:
            OpenSplashView("Übersetzung", translation)
        else:
